...
latest_release_date <- "October 10, 2020"
...
needed_CRAN_pkgs <- c(
  ...
  "infer", "moderndive","googleway","rebus","here",
...
if (is_html_output()) {
  cat("# Welcome to HR Analytics.live {-}")
}
```
...
**This is a previous version (v`r version`) of *HR Analytics.live* and may be out of date. For the current version of *HR Analytics.live*, please go to [hranalytics.live](https://hranalyticslive.netlify.app//).**
```
-->
...
**Please note that you are currently looking at the latest version of “HR Analytics in R”. However, since work is still in progress subject to change about twice a year. Please feel free to contact me, as your comments are motivating me to do better.**
```
...
**Please note that you are currently looking at the latest version of "HR Analytics in R".**
```
...
* Please let me know if you find any errors, typos, or areas from improvement on my [GitHub issue page](https://github.com/Hendrik147/HR_Analytics_in_R_book_v2/issues) page. I will fix it as soon as possible.
